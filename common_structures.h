...
typedef struct {
  ...
  double observed_phi[1000]; /* pointer to the grainsize distribution, 100 possible bins, from collected samples */
  double calculated_phi[1000]; /*pointer to a grainsize distribution of 100 possible bins or grain sizes */
